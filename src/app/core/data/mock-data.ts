...
সামাজিক উন্নয়ন: ধর্মীয় নেতাদের সামাজিক মর্যাদা নিশ্চিত করা এবং খেলাধুলার প্রসারের মাধ্যমে তরুণ প্রজন্মকে বিপথগামী হওয়া থেকে রক্ষা করা। তিনি একটি বৈষম্যহীন ঢাকা-২ গড়তে অঙ্গীকারবদ্ধ, যেখানে উন্নয়ন হবে টেকসই এবং জনমুখী।`;
        ...
        if (slug === 'khondakerabuashfaque') {
            ...
            bio = `খন্দকার আবু আশফাক একজন নিবেদিতপ্রাণ রাজনৈতিক ব্যক্তিত্ব এবং ২০২৬ সালের ত্রয়োদশ জাতীয় সংসদ নির্বাচনে ঢাকা-১ আসন থেকে বাংলাদেশ জাতীয়তাবাদী দলের (বিএনপি) মনোনীত প্রার্থী। বর্তমানে তিনি ঢাকা জেলা বিএনপির সভাপতি এবং দলের জাতীয় নির্বাহী কমিটির সদস্য হিসেবে গুরুত্বপূর্ণ দায়িত্ব পালন করছেন। দোহার ও নবাবগঞ্জের মাটি ও মানুষের সাথে তাঁর রয়েছে দীর্ঘদিনের নিবিড় সম্পর্ক। আসন্ন নির্বাচনে তিনি কেবল একজন প্রার্থী নন, বরং একটি ইতিবাচক ও কাঠামোগত পরিবর্তনের অগ্রদূত হিসেবে নিজেকে নিবেদন করেছেন।`;
            ...
            constituency_plan = `খন্দকার আবু আশফাক ঢাকা-১ আসনকে একটি ভারসাম্যপূর্ণ, অন্তর্ভুক্তিমূলক ও টেকসই এলাকা হিসেবে গড়ে তুলতে চান। দলের ঘোষিত “পরিবর্তনের রাজনীতি”-র আলোকে ঢাকা-১ আসনের জন্য খন্দকার আবু আশফাক এক আধুনিক ও জনবান্ধব রূপকল্প প্রণয়ন করেছেন। তাঁর প্রধান লক্ষ্যসমূহ হলো:

কৃষি ও কর্মসংস্থান: দোহার-নবাবগঞ্জের কৃষকদের জন্য আধুনিক সুযোগ-সুবিধা নিশ্চিত করা এবং তরুণ প্রজন্মের জন্য স্থানীয় পর্যায়ে কর্মসংস্থানের ব্যবস্থা করা।

স্বাস্থ্য ও শিক্ষা: এলাকার প্রতিটি পরিবারের জন্য মানসম্মত স্বাস্থ্যসেবা ও উন্নত শিক্ষা কাঠামো নিশ্চিত করা।

পরিবেশ ও অবকাঠামো: পদ্মা নদী সংলগ্ন এলাকার ভাঙন রোধে কার্যকর পদক্ষেপ গ্রহণ এবং পরিবেশ রক্ষায় বিশেষ উদ্যোগ নেওয়া।

সামাজিক উন্নয়ন: ধর্মীয় নেতাদের সামাজিক মর্যাদা ও সহায়তা নিশ্চিত করা এবং খেলাধুলার প্রসারের মাধ্যমে যুবসমাজকে মাদক ও অবক্ষয় থেকে দূরে রাখা। একটি স্বচ্ছ ও জবাবদিহিমূলক প্রশাসনিক ব্যবস্থার মাধ্যমে ঢাকা-১ আসনকে উন্নয়নের মডেলে রূপান্তর করাই তাঁর মূল অঙ্গীকার।

জনগণের প্রতি দায়বদ্ধ নেতৃত্ব, গণতান্ত্রিক অংশগ্রহণ এবং বাস্তবসম্মত উন্নয়নের মাধ্যমে তিনি এমন একটি ঢাকা-১ গড়তে চান, যা সকলের জন্য নিরাপদ ও সম্ভাবনাময়।`;

            political_journey = `খন্দকার আবু আশফাকের রাজনৈতিক জীবন গণতান্ত্রিক মূল্যবোধ এবং দলীয় আদর্শের প্রতি অবিচল আস্থার এক উজ্জ্বল দৃষ্টান্ত। তৃণমূল পর্যায় থেকে শুরু করে বর্তমানে ঢাকা জেলা বিএনপির নেতৃত্বে তাঁর অবস্থান দলের সাংগঠনিক ভিত মজবুত করতে সহায়ক হয়েছে। কেন্দ্রীয় নির্বাহী কমিটির সদস্য হিসেবে তিনি দীর্ঘকাল ধরে দলের নীতি-নির্ধারণী প্রক্রিয়ায় অবদান রেখে চলেছেন। প্রতিকূল রাজনৈতিক পরিস্থিতিতেও তিনি সাধারণ মানুষের অধিকার আদায়ের সংগ্রামে সবসময় সামনের সারিতে থেকেছেন, যা তাঁকে একজন নির্ভরযোগ্য ও সাহসী নেতা হিসেবে প্রতিষ্ঠিত করেছে।`;

            personal_life = `পারিবারিক মূল্যবোধ ও সামাজিক দায়বদ্ধতাকে ধারণ করে বড় হওয়া খন্দকার আবু আশফাক একজন মার্জিত ও শিক্ষিত ব্যক্তিত্ব। তাঁর ব্যক্তিগত জীবন সততা এবং নিষ্ঠার ওপর ভিত্তি করে গড়ে উঠেছে। তিনি বিশ্বাস করেন, ব্যক্তিগত সততাই একজন জনপ্রতিনিধিকে জনগণের কাছাকাছি নিয়ে যায়। প্রচারবিমুখ এই নেতা সবসময়ই পর্দার আড়ালে থেকে সাধারণ মানুষের কল্যাণে কাজ করতে পছন্দ করেন এবং পেশাদারিত্বের সাথে তাঁর রাজনৈতিক কর্মকাণ্ড পরিচালনা করেন।`;
            gallery = [
...
export const SEATS: any[] = [
    { id: 1, district_id: 1, name: 'ঢাকা-১', name_en: 'Dhaka-1', candidate_slug: 'khondakerabuashfaque', candidate_name: 'খন্দকার আবু আশফাক', candidate_photo: 'https://khondakerabuashfaque.yourleader.org/wp-content/uploads/2026/01/Khondaker-Abu-Ashfaque-.jpg' },
    { id: 2, district_id: 1, name: 'ঢাকা-২', name_en: 'Dhaka-2', candidate_slug: 'amanullahaman', candidate_name: 'আমানউল্লাহ আমান', candidate_photo: 'https://lh3.googleusercontent.com/d/1vKpmDLxP940moQ7Rw-DsYFqJNpMAQzis' },
    { id: 3, district_id: 1, name: 'ঢাকা-৩', name_en: 'Dhaka-3', candidate_slug: 'goyeswarroy', candidate_name: 'গয়েশ্বর চন্দ্র রায়', candidate_photo: 'https://i.pravatar.cc/150?u=goyeswar' },
    { id: 4, district_id: 1, name: 'ঢাকা-৪', name_en: 'Dhaka-4', candidate_slug: 'tanveerahmed', candidate_name: 'তানভীর আহমেদ রবিন', candidate_photo: 'https://i.pravatar.cc/150?u=tanveer' },
    { id: 5, district_id: 1, name: 'ঢাকা-৫', name_en: 'Dhaka-5', candidate_slug: 'alhaznabiullahnab', candidate_name: 'আলহাজ্ব নবী উল্লাহ নবী', candidate_photo: 'https://i.pravatar.cc/150?u=nabiullah' },
    { id: 6, district_id: 1, name: 'ঢাকা-৬', name_en: 'Dhaka-6', candidate_slug: 'ishraquehossain', candidate_name: 'ইশরাক হোসেন', candidate_photo: 'https://i.pravatar.cc/150?u=ishraque' },
    { id: 7, district_id: 1, name: 'ঢাকা-৭', name_en: 'Dhaka-7', candidate_slug: 'hamidurrahmanhamid', candidate_name: 'হামিদুর রহমান হামিদ', candidate_photo: 'https://i.pravatar.cc/150?u=hamid' },
    { id: 8, district_id: 1, name: 'ঢাকা-৮', name_en: 'Dhaka-8', candidate_slug: 'mirzaabbas', candidate_name: 'মির্জা আব্বাস', candidate_photo: 'https://i.pravatar.cc/150?u=mirza' },
    { id: 9, district_id: 1, name: 'ঢাকা-৯', name_en: 'Dhaka-9', candidate_slug: 'habiburrashidhabib', candidate_name: 'হাবিব উন রশিদ হাবিব', candidate_photo: 'https://i.pravatar.cc/150?u=habibur' },
    { id: 10, district_id: 1, name: 'ঢাকা-১০', name_en: 'Dhaka-10', candidate_slug: 'shaikhrabiulalam', candidate_name: 'শেখ রবিউল আলম রবি', candidate_photo: 'https://i.pravatar.cc/150?u=shaikh' },
    { id: 11, district_id: 1, name: 'ঢাকা-১১', name_en: 'Dhaka-11', candidate_slug: 'maquayum', candidate_name: 'এমএ কাইউম', candidate_photo: 'https://i.pravatar.cc/150?u=quayum' },
    { id: 12, district_id: 1, name: 'ঢাকা-১২', name_en: 'Dhaka-12', candidate_slug: 'saifulalamnirob', candidate_name: 'সাইফুল আলম নীরব', candidate_photo: 'https://i.pravatar.cc/150?u=saiful' },
    { id: 13, district_id: 1, name: 'ঢাকা-১৩', name_en: 'Dhaka-13', candidate_slug: 'bobbyhajjaj', candidate_name: 'ববি হাজ্জাজ', candidate_photo: 'https://i.pravatar.cc/150?u=bobby' },
    { id: 14, district_id: 1, name: 'ঢাকা-১৪', name_en: 'Dhaka-14', candidate_slug: 'sanjidaislamtulee', candidate_name: 'সানজিদা ইসলাম তুলি', candidate_photo: 'https://i.pravatar.cc/150?u=sanjida' },
    { id: 15, district_id: 1, name: 'ঢাকা-১৫', name_en: 'Dhaka-15', candidate_slug: 'safiqulislamkhanmilton', candidate_name: 'শফিকুল ইসলাম খান মিল্টন', candidate_photo: 'https://i.pravatar.cc/150?u=safiqul' },
    { id: 16, district_id: 1, name: 'ঢাকা-১৬', name_en: 'Dhaka-16', candidate_slug: 'aminulhaque', candidate_name: 'আমিনুল হক', candidate_photo: 'https://i.pravatar.cc/150?u=aminul' },
    { id: 17, district_id: 1, name: 'ঢাকা-১৭', name_en: 'Dhaka-17', candidate_slug: 'tariquerahman', candidate_name: 'তারেক রহমান', candidate_photo: 'https://i.pravatar.cc/150?u=tarique' },
    { id: 18, district_id: 1, name: 'ঢাকা-১৮', name_en: 'Dhaka-18', candidate_slug: 'smjahangirhossain', candidate_name: 'এস এম জাহাঙ্গীর হোসেন', candidate_photo: 'https://i.pravatar.cc/150?u=jahangir' },
    { id: 19, district_id: 1, name: 'ঢাকা-১৯', name_en: 'Dhaka-19', candidate_slug: 'dewanmohammodsalahuddinbabu', candidate_name: 'দেওয়ান মোহাম্মদ সালাউদ্দিন বাবু', candidate_photo: 'https://i.pravatar.cc/150?u=dewan' },
    { id: 20, district_id: 1, name: 'ঢাকা-২০', name_en: 'Dhaka-20', candidate_slug: 'alhajtamizuddin', candidate_name: 'আলহাজ্ব তমিজ উদ্দিন', candidate_photo: 'https://i.pravatar.cc/150?u=tamizuddin' },
    { id: 21, district_id: 2, name: 'গাজীপুর-১', name_en: 'Gazipur-1', candidate_slug: 'maziburrahman', candidate_name: 'মজিবুর রহমান', candidate_photo: 'https://i.pravatar.cc/150?u=mazibur' },
    { id: 22, district_id: 2, name: 'গাজীপুর-২', name_en: 'Gazipur-2', candidate_slug: 'mmanjurulkarimroni', candidate_name: 'এম মঞ্জুরুল করিম রনি', candidate_photo: 'https://i.pravatar.cc/150?u=manjurul' },
    { id: 23, district_id: 2, name: 'গাজীপুর-৩', name_en: 'Gazipur-3', candidate_slug: 'smrafiqulislambachchu', candidate_name: 'এস এম রফিকুল ইসলাম বাচ্চু', candidate_photo: 'https://i.pravatar.cc/150?u=bachchu' },
    { id: 24, district_id: 2, name: 'গাজীপুর-৪', name_en: 'Gazipur-4', candidate_slug: 'shahreazulhannan', candidate_name: 'শাহ রিয়াজুল হান্নান', candidate_photo: 'https://i.pravatar.cc/150?u=shahreazul' },
    { id: 25, district_id: 2, name: 'গাজীপুর-৫', name_en: 'Gazipur-5', candidate_slug: 'fazlulhaquemilan', candidate_name: 'ফজলুল হক মিলন', candidate_photo: 'https://i.pravatar.cc/150?u=milan' },
